...
import { GERENCIA_CATEGORIES, authHeaders } from "@components/gerencia/gerencia-constants.js";
...
export default function AddTransactionModal({ isOpen, onClose, urlApi, refresh }) {
  ...
  const handleSave = () => {
    ...
    toast.promise(
      axios
        .post(`${urlApi}gerencia/transactions`, payload, {
          headers: authHeaders(),
        })
        .then((response) => {
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            placeholder="Ej. Arriendo oficina agosto"
          />
        </div>
