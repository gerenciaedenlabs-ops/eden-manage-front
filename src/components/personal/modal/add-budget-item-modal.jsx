...
import { PERSONAL_CATEGORIES, DAY_OPTIONS, authHeaders } from "@components/personal/personal-constants.js";
...
export default function AddBudgetItemModal({ isOpen, onClose, urlApi, refresh }) {
  ...
  const handleSave = () => {
    ...
    toast.promise(
      axios
        .post(`${urlApi}personal/budget-items`, payload, {
          headers: authHeaders(),
        })
        .then((response) => {
    ...
    >
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Un ingreso o gasto que se repite cada mes (arriendo, suscripciones...).
        </p>
      </div>
